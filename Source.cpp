...
int main()
{
	...
	case 3:
		...
		cin >> complex.real_part >> complex.fake_part;
	...
	case 4:
		...
		cout << "Enter action with vector (+ or -): ";
		...
		{
		case '+':
			//vector1 = vector1.vector_sum(&vector2);
			vector1.vector_sum(&vector2);

			break;

		case '-':
			//vector1 = vector1.vector_minus(&vector2);
			vector1.vector_minus(&vector2);

			break;
		}

		cout << "Moduls of vectors: " << vector1.modul << "," << vector2.modul << endl;
